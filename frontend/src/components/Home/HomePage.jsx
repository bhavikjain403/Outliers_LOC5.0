    ...
    return (
        ...
        <div className="vision">
            <div className="vision_head">
                <div className="vision_header"><img src={logo} alt=".." style={{ maxHeight:"250px", marginTop:"-5rem" }} /></div>
                <div className="vision_img"><img src={img5} alt=".." style={{ maxWidth:"110%", marginTop:"-9rem" }} /></div>
